...
// 		cy.window().its('itds').then(itds => {
// 			itds.call("itds.tests.ui_test_helpers.create_todo_records");
// 		});
// 	});
...
// 		cy.intercept('POST', '/api/method/itds.desk.reportview.get').as('list_refresh');
...
// 		cy.intercept('POST', '/api/method/itds.model.utils.user_settings.save')
