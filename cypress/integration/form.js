...
context("Form", () => {
	before(() => {
		...
		return cy
			...
			.its("itds")
			.then((itds) => {
				return itds.call("itds.tests.ui_test_helpers.create_contact_records");
			});
	});
	...
	it("create a new form", () => {
		...
		cy.intercept({
			method: "POST",
			url: "api/method/itds.desk.form.save.savedocs",
		}).as("form_save");
	...
	it("validates behaviour of Data options validations in child table", () => {
		...
		cy.get('.itds-control[data-fieldname="email_ids"]').as("table");
