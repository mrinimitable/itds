...
context("Sidebar", () => {
	before(() => {
		...
		return cy
			...
			.its("itds")
			.then((itds) => {
				return itds.call("itds.tests.ui_test_helpers.create_blog_post");
			});
	});

	it("Verify attachment visibility config", () => {
		cy.call("itds.tests.ui_test_helpers.create_todo", {
	...
	it("Verify attachment accessibility UX", () => {
		cy.call("itds.tests.ui_test_helpers.create_todo_with_attachment_limit", {
