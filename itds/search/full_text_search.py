...
class FullTextSearch:
	...
	def create_index(self):
		itds.create_folder(self.index_path)
	...
	def search(self, text: str, scope: str | None = None, limit: int = 20) -> list[itds._dict]:
...
def get_index_path(index_name):
	return itds.get_site_path("indexes", index_name)
