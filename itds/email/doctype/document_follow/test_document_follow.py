...
import itds
import itds.desk.form.document_follow as document_follow
from itds.desk.form.assign_to import add
from itds.desk.form.document_follow import get_document_followed_by_user
from itds.desk.form.utils import add_comment
from itds.desk.like import toggle_like
from itds.query_builder import DocType
from itds.query_builder.functions import Cast_
from itds.share import add as share
...
class TestDocumentFollow(IntegrationTestCase):
	...
	def tearDown(self):
		...
		itds.db.delete("Document Follow")
	...
	doc = itds.get_doc(
		{
			...
			"doc.starts_on": itds.utils.now(),
			"doc.ends_on": itds.utils.add_days(itds.utils.now(), 5),
...
def get_user(document_follow=None):
	...
	if itds.db.exists("User", "test@docsub.com"):
		doc = itds.delete_doc("User", "test@docsub.com")
	doc = itds.new_doc("User")
