			...
			frm.add_custom_button(
				...
				function () {
					itds.prompt(
						...
						function (data) {
							itds.call({
								method: "itds.email.doctype.email_group.email_group.import_from",
								args: {
									name: frm.doc.name,
			...
			frm.add_custom_button(
				...
				function () {
					itds.prompt(
						...
						function (data) {
							itds.call({
								method: "itds.email.doctype.email_group.email_group.add_subscribers",
								args: {
									name: frm.doc.name,
