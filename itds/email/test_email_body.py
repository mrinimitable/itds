...
import itds
from itds import safe_decode
from itds.core.doctype.communication.communication import Communication
from itds.email.doctype.email_queue.email_queue import QueueBuilder, SendMailContext
from itds.email.email_body import (
	get_email,
	get_header,
	inline_style_in_html,
	replace_filename_with_cid,
)
from itds.email.receive import Email, InboundMail
...
<div>
	...
	<img embed="assets/itds/images/itds-favicon.svg" />
</div>
"""
		email_text = """
Hey John Doe!
...
"""
		...
		img_path = os.path.abspath("assets/itds/images/itds-favicon.svg")
	...
	def test_prepare_message_returns_already_encoded_string(self):
		...
		queue_doc = itds.get_last_doc("Email Queue")
...
Content-Disposition: inline; filename="itds-favicon.svg"
"""
...
"""
	...
	def test_replace_filename_with_cid(self):
		original_message = """
			<div>
				<img embed="assets/itds/images/itds-favicon.svg" alt="test" />
...
"""
		...
		# https://github.com/mrinimitable/itds/pull/3371
		# self.assertEqual(mail.from_real_name, '"fail@example.com" via DEF')

		email_account = itds._dict({"email_id": "receive@example.com"})
