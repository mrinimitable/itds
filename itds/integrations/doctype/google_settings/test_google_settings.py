...
class TestGoogleSettings(IntegrationTestCase):
	def setUp(self):
		settings = itds.get_single("Google Settings")
	...
	def test_picker_disabled(self):
		...
		itds.db.set_single_value("Google Settings", "enable", 1)
		itds.db.set_single_value("Google Settings", "google_drive_picker_enabled", 0)
	...
	def test_google_disabled(self):
		...
		itds.db.set_single_value("Google Settings", "enable", 0)
		itds.db.set_single_value("Google Settings", "google_drive_picker_enabled", 1)
		settings = get_file_picker_settings()
