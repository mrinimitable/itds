import itds
from itds.patches.v13_0.encrypt_2fa_secrets import DOCTYPE
from itds.patches.v13_0.encrypt_2fa_secrets import PARENT_FOR_DEFAULTS as TWOFACTOR_PARENT
...
def execute():
	...
	https://github.com/mrinimitable/itds/commit/a822092211533ff17ff9b92dd86f6f868ed63e2e
	"""
	...
	# letter head
	try:
		letter_head = itds.get_doc("Letter Head", {"is_default": 1})
