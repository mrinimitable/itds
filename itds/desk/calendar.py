...
def update_event(args, field_map):
	...
	args = itds._dict(json.loads(args))
	field_map = itds._dict(json.loads(field_map))
	w = itds.get_doc(args.doctype, args.name)
...
def get_events(doctype, start, end, field_map, filters=None, fields=None):
	...
	doc_meta = itds.get_meta(doctype)
	...
	return itds.get_list(doctype, fields=fields, filters=filters)
