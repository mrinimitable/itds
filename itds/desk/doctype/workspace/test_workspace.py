...
class TestWorkspace(IntegrationTestCase):
	...
	def tearDown(self):
		itds.db.delete("Workspace", {"module": "Test Module"})
		itds.db.delete("DocType", {"module": "Test Module"})
		itds.delete_doc("Module Def", "Test Module")
	...
	# 	if itds.get_system_settings('country') == "France":
...
def create_module(module_name):
	module = itds.get_doc({"doctype": "Module Def", "module_name": module_name, "app_name": "itds"})
...
def create_workspace(**args):
	workspace = itds.new_doc("Workspace")
