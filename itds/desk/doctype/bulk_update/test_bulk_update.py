...
from itds.desk.doctype.bulk_update.bulk_update import submit_cancel_or_update_docs
...
class TestBulkUpdate(IntegrationTestCase):
	...
	def setUpClass(cls) -> None:
		...
		itds.db.commit()
		for _ in range(50):
			itds.new_doc(cls.doctype, some_fieldname=itds.mock("name")).insert()
	...
	def test_bulk_submit_in_background(self):
		...
		submitted = itds.get_all(self.doctype, {"docstatus": 1}, limit=20, pluck="name")
