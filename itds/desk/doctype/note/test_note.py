# Copyright (c) 2015, Itds Technologies Pvt. Ltd. and Contributors and Contributors
...
class TestNote(IntegrationTestCase):
	def insert_note(self):
		itds.db.delete("Version")
		itds.db.delete("Note")
		itds.db.delete("Note Seen By")

		return itds.get_doc(doctype="Note", title="test note", content="test note content").insert()
	...
	def test_version(self):
		...
		version = itds.get_doc("Version", dict(docname=note.name))
