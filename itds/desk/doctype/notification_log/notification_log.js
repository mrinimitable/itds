...
itds.ui.form.on("Notification Log", {
	...
	set_attachment: function (frm) {
		...
		$wrapper.find(".attached-file-link").click(() => {
			const w = window.open(
				itds.urllib.get_full_url(`/api/method/itds.utils.print_format.download_pdf?
