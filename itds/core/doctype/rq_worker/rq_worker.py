...
from itds.utils import cint, convert_utc_to_system_timezone
from itds.utils.background_jobs import get_workers
...
def serialize_worker(worker: Worker) -> itds._dict:
	...
	if current_job and not current_job.startswith(itds.local.site):
		current_job = None
