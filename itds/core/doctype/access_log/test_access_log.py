...
class TestAccessLog(IntegrationTestCase):
	def setUp(self):
		...
		self.file_name = itds.utils.random_string(10) + ".txt"
		self.test_content = itds.utils.random_string(1024)
	...
	def test_make_full_access_log(self):
		...
		last_doc = itds.get_last_doc("Access Log")
	...
	def test_private_file_download(self):
		...
		private_file_link = get_site_url(itds.local.site) + new_private_file.file_url
