...
itds.query_reports["Database Storage Usage By Tables"] = {
	filters: [],
			...
			function () {
				let d = new itds.ui.Dialog({
					...
					primary_action(values) {
						itds.call({
							method: "itds.core.report.database_storage_usage_by_tables.database_storage_usage_by_tables.optimize_doctype",
							args: {
