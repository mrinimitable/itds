...
class TestHelpArticle(IntegrationTestCase):
	...
	def setUpClass(cls) -> None:
		cls.help_category = itds.get_doc(
			{
	...
	def test_article_is_helpful(self):
		from itds.website.doctype.help_article.help_article import add_feedback
	...
	def tearDownClass(cls) -> None:
		itds.delete_doc(cls.help_article.doctype, cls.help_article.name)
		itds.delete_doc(cls.help_category.doctype, cls.help_category.name)
