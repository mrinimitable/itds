...
def get_context(context):
	should_cache = not_modified_recently(itds.get_website_settings("modified"))

	website_script = itds.get_cached_doc("Website Script")
...
def get_setting(field_name):
	...
	website_settings = itds.get_website_settings(field_name)
	conf = itds.conf.get(field_name)
