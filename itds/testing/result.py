...
to provide custom formatting and logging for test results in the Itds framework.
...
test results during test execution in the Itds framework.
"""
...
class TestResult(unittest.TextTestResult):
	...
	def startTestRun(self):
		if not sys.warnoptions:
			...
			from itds.deprecation_dumpster import ItdsDeprecationWarning

			warnings.simplefilter("ignore")
			warnings.filterwarnings("module", category=ItdsDeprecationWarning)
...
class ItdsTestResult(unittest.TextTestResult):
	def __init__(self, stream, descriptions, verbosity):
		super().__init__(stream, descriptions, verbosity)
