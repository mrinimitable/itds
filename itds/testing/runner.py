"""
This module contains the TestRunner class, which is responsible for executing test suites in Itds.
...
- Integration with Itds's configuration and environment setup
...
Usage:
The TestRunner is typically instantiated and used by Itds's test discovery and execution system.
...
class TestRunner(unittest.TextTestRunner):
	...
	def _prepare_category(self, category, suite, app):
		from itds.deprecation_dumpster import get_compat_itds_test_case_preparation

		dispatcher = {
			"integration": self.integration_preparation,
			"old-itds-test-class-category": get_compat_itds_test_case_preparation(self.cfg),
