...
class DbManager:
	def __init__(self, db: itds.database.database.Database | None = None):
		"""
	...
	def restore_database(verbose: bool, target: str, source: str, user: str, password: str) -> None:
		...
		from itds.utils import execute_in_shell
		...
		itds.cache.delete_keys("")  # Delete all keys associated with this site.
