...
class UnitTestCase(unittest.TestCase, BaseTestCase):
	"""Unit test class for Itds tests.

	This class extends unittest.TestCase and provides additional utilities
	specific to Itds framework. It's designed for testing individual
	...
	def setUpClass(cls) -> None:
		...
		cls.module = itds.get_module(cls.__module__)
		# Test Environment
		itds.set_user("Administrator")
		# Test Environment (cleanup)
		cls.addClassCleanup(itds.set_user, "Administrator")
...
def _get_doctype_from_module(cls):
	...
	path = itds.get_pymodule_path(cls.__module__)
	try:
