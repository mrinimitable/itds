...
export function getStore(print_format_name) {
	...
	function fetch() {
		return new Promise((resolve) => {
			itds.model.clear_doc("Print Format", print_format_name);
			itds.model.with_doc("Print Format", print_format_name, () => {
				let _print_format = itds.get_doc("Print Format", print_format_name);
				itds.model.with_doctype(_print_format.doc_type, () => {
					meta.value = itds.get_meta(_print_format.doc_type);
	...
	function change_letterhead(_letterhead) {
		return itds.db.get_doc("Letter Head", _letterhead).then((doc) => {
