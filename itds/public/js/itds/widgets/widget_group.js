...
itds.provide("itds.widget");

itds.widget.widget_factory = {
	chart: ChartWidget,
	base: BaseWidget,
...
itds.widget.make_widget = (opts) => {
	const widget_class = itds.widget.widget_factory[opts.widget_type];
	if (widget_class) {
...
export default class WidgetGroup {
	...
	add_widget(widget) {
		let widget_object = itds.widget.make_widget({
			...widget,
...
itds.widget.WidgetGroup = WidgetGroup;
itds.widget.SingleWidgetGroup = SingleWidgetGroup;
