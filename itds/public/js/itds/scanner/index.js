...
itds.ui.Scanner = class Scanner {
	constructor(options) {
		...
		if (options.container) {
			...
			this.scan_area_id = itds.dom.set_unique_id(this.$scan_area);
		}
		if (options.dialog) {
	...
	load_lib() {
		return itds.require("/assets/itds/node_modules/html5-qrcode/html5-qrcode.min.js");
	}
};
