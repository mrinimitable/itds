import { Chart } from "itds-charts/dist/itds-charts.esm";

itds.provide("itds.ui");
itds.Chart = Chart;

itds.ui.RealtimeChart = class RealtimeChart extends itds.Chart {
	constructor(element, socketEvent, maxLabelPoints = 8, data) {
		...
		this.start_updating = function () {
			itds.realtime.on(this.socketEvent, (data) => {
				this.update_chart(data.label, data.points);
			});
		};

		this.stop_updating = function () {
			itds.realtime.off(this.socketEvent);
		};
