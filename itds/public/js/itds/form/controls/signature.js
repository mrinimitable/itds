itds.ui.form.ControlSignature = class ControlSignature extends itds.ui.form.ControlData {
	make() {
		var me = this;
		this.saving = false;
		this.loading = false;
		...
		itds.require("/assets/itds/js/lib/jSignature.min.js").then(() => {
		...
		this.img_wrapper = $(`<div class="signature-display">
			<div class="missing-image attach-missing-image">
				${itds.utils.icon("restriction", "md")}</i>
