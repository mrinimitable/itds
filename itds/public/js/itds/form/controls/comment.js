...
itds.ui.form.ControlComment = class ControlComment extends itds.ui.form.ControlTextEditor {
	make_wrapper() {
		this.comment_wrapper = !this.no_wrapper
			...
			<div class="comment-input-wrapper">
				...
				${itds.avatar(itds.session.user, "avatar-medium")}
					<div class="itds-control col"></div>
				</div>
		...
		`)
			: $('<div class="itds-control"></div>');

		this.comment_wrapper.appendTo(this.parent);

		// wrapper should point to itds-control
		this.$wrapper = !this.no_wrapper
			? this.comment_wrapper.find(".itds-control")
