...
import itds
from itds import _
from itds.utils import get_shashi_path, get_site_path
from itds.utils.file_lock import LockTimeoutError
...
def filelock(lock_name: str, *, timeout=30, is_global=False):
	...
	try:
		...
		itds.log_error(f"Filelock: Failed to aquire {lock_path}")
