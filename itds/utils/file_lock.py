...
Use `itds.utils.synchroniztion.filelock` for process synchroniztion.
"""
...
import itds
from itds.utils import get_site_path, touch_file
...
def release_document_locks():
	...
	for doc in itds.local.locked_documents:
		doc.unlock()
